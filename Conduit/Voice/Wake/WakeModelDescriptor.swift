...
struct WakeModelDescriptor: Codable, Equatable, Identifiable {
    ...
    static var bundledBilingualPack: WakeModelDescriptor { WakeModelDescriptor(
        id: "sherpa-onnx-kws-zipformer-zh-en-3m-chunk8",
        displayName: AppLocalization.string("English + Chinese wake phrases"),
        ...
        assets: [
            .init(relativePath: "encoder-epoch-13-avg-2-chunk-8-left-64.int8.onnx", purpose: AppLocalization.string("quantized encoder"), sha256: nil, checksumStatus: .notRecorded),
            .init(relativePath: "decoder-epoch-13-avg-2-chunk-8-left-64.onnx", purpose: AppLocalization.string("decoder"), sha256: nil, checksumStatus: .notRecorded),
            .init(relativePath: "joiner-epoch-13-avg-2-chunk-8-left-64.int8.onnx", purpose: AppLocalization.string("quantized joiner"), sha256: nil, checksumStatus: .notRecorded),
            .init(relativePath: "tokens.txt", purpose: AppLocalization.string("keyword tokens"), sha256: nil, checksumStatus: .notRecorded),
            .init(relativePath: "en.phone", purpose: AppLocalization.string("English pronunciation lexicon"), sha256: nil, checksumStatus: .notRecorded)
        ]
    )
    }
}
